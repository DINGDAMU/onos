 ...
 */
public class MMwaveDemoLink extends BiLink {

    private boolean important = false;
    private String label = null;

    public MMwaveDemoLink(LinkKey key, Link link) {
        super(key, link);
    }

    public MMwaveDemoLink makeImportant() {
        important = true;
        return this;
    }

    public MMwaveDemoLink setLabel(String label) {
        this.label = label;
        return this;
    }
