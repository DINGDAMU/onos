...
/**
 * Created by dingdamu on 2017/4/3.
 */
public class MMWaveIntentCodec extends JsonCodec<MMWaveIntent> {
    ...
    @Override
    public MMWaveIntent decode(ObjectNode json, CodecContext context) {
        MMWaveIntent.Builder builder = MMWaveIntent.builder();
